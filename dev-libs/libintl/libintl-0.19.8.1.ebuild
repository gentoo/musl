...
multilib_src_install() {
	...
	# we don't need the header file since it would conflict with
	# sys-libs/musl which installs its own libintl.h file
	use elibc_musl && rm -f "${D}/usr/include/libintl.h"
}
