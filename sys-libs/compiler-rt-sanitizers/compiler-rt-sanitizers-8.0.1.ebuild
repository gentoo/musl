...
PATCHES=( "${FILESDIR}"/0001-compiler-rt-sanitizers-8.0.1-musl.patch
	"${FILESDIR}"/0002-compiler-rt-sanitizers-8.0.1-musl.patch
	"${FILESDIR}"/0003-fixup-for-interception_type_test.patch
	)
